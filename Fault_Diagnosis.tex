...
Equation \eqref{eq:1} in section \uppercase\expandafter{\romannumeral2} can be generalized to k phase as\\
\begin{equation}\label{eq:8}
I_{i}(t)=I_{1}(t)+I_{2}(t)+...+I_{k}(t)
\end{equation}
Assumed that an OCF occurs in T1, DC-link current is equal to sum of inductor currents of the rest healthy phases\\
\begin{equation}\label{eq:9}
I_{i}(t)=I_{2}(t)+I_{3}(t)+...+I_{k}(t)
\end{equation}
